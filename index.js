...
const makeTransaction = (transaction) => {
    ...
    function logSuccess({id, time }) { console.log(`Transaction ${id} processed in ${time}ms`); };
    
    function logError(id) {  console.warn(`Error processing transaction ${id}. Please try again later.`);};
